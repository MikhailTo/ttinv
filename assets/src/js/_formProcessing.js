...
class ItcSubmitForm {
  ...
  _setStateValidaion(input, state, message) {
    ...
    input.closest('.form__group').querySelector('.invalid-feedback').textContent = '';
    if (state === 'error' || state === 'success') {
      input.classList.add(className);
      input.closest('.form__group').querySelector('.invalid-feedback').textContent = text;
    }
  }
  ...
  _errorXHR() {
    this._elForm.querySelector('.form__error').classList.remove('d-none');
  }
  ...
  _onSubmit() {
    ...
    this._elForm.querySelector('.form__error').classList.add('form__error_hide');
  ...
  // сброс формы
  reset() {
    if (this._elForm.querySelector('.form__error')) {
      this._elForm.querySelector('.form__error').classList.add('form__error_hide');
    }
    this._elForm.reset();
    this._elForm.querySelectorAll('input, textarea').forEach(el => {
